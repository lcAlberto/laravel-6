...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function paginate($perPage, $currentPage = null)
        {
                        return \Illuminate\Support\Collection::paginate($perPage, $currentPage);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function allEquals($callback = null)
        {
                        return \Illuminate\Support\Collection::allEquals($callback);
        }
